...
import { PiTrashBold as ClearIcon, PiMagnifyingGlassDuotone } from 'react-icons/pi';
import { ActionIcon, Button, CardSection, Group, Pill, Text, type GroupProps } from '@mantine/core';
...
export const DataTableFilters = forwardRef<HTMLDivElement, DataTableFiltersProps>(
  ({ filters, onClear, onSubmit, py = 'md', ...props }, ref) => {
